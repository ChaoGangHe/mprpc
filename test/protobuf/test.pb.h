...
class ResultCode :
 ...
 public:
  ...
  // int32 errcpde = 1;
  void clear_errcpde();
  ::PROTOBUF_NAMESPACE_ID::int32 errcpde() const;
  void set_errcpde(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_errcpde() const;
  void _internal_set_errcpde(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 errcpde_;
...
// int32 errcpde = 1;
inline void ResultCode::clear_errcpde() {
  errcpde_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ResultCode::_internal_errcpde() const {
  return errcpde_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ResultCode::errcpde() const {
  // @@protoc_insertion_point(field_get:fixbug.ResultCode.errcpde)
  return _internal_errcpde();
}
inline void ResultCode::_internal_set_errcpde(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  errcpde_ = value;
}
inline void ResultCode::set_errcpde(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_errcpde(value);
  // @@protoc_insertion_point(field_set:fixbug.ResultCode.errcpde)
}
