...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::fixbug::ResultCode, errcpde_),
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          errcpde_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* ResultCode::_InternalSerialize(
  ...
  if (this->errcpde() != 0) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(1, this->_internal_errcpde(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.ResultCode)
  ...
  if (from.errcpde() != 0) {
    _internal_set_errcpde(from._internal_errcpde());
  }
}
